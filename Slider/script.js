...
elems.forEach(function (elem) {
    ...
    var index = 0;
    var animating = false;
document.querySelector("#main").addEventListener("click",function name() {
if (!animating) {
    animating = true;
    gsap.to(h1s[index],{
        top:"-=100%",   
